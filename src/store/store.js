        ...
        sumaCategoria:(state,cantidad)=>{
            for (i = 0; i < 6; i++) { 
                if(state.categorias[i].seleccionado==1){
                    ...
                    if(n=='hogar'){state.generos[0].hogar=state.generos[0].hogar + cantidad;
                    }else if(n=='transporte'){state.generos[0].transporte=state.generos[0].transporte + cantidad;
                    }else if(n=='restaurante'){state.generos[0].restaurante=state.generos[0].restaurante + cantidad;
                    }else if(n=='salud'){state.generos[0].salud=state.generos[0].salud + cantidad;
                    }else if(n=='ocio'){state.generos[0].ocio=state.generos[0].ocio + cantidad;
                    }else if(n=='supermercado'){state.generos[0].supermercado=state.generos[0].supermercado + cantidad;
                    }
